...
How the body reads is governed by `references/narrative-devices.md`, which is not optional and not stylistic preference: the devices there are what make a block get quoted rather than filed. Read it before writing the body.
...
**3. Assumptions and how to kill them**
...
The last thing in the block before the close. One short titled passage, set apart, that a person could repeat from memory. Device 10 in `references/narrative-devices.md` governs its form. Not a summary of the section — the decision itself, in its most compressed defensible form. Most blocks in the canvas fail downstream because nobody can remember what was decided.
...
Depth changes the body only. Header, assumptions, downstream impact, contradictions, extract, definitive north, and close are mandatory at every level.
